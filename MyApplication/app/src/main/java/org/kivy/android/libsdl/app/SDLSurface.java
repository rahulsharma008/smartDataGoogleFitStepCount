...
*/
                    /*
                    r2 = this;
                    r0 = r1;	 Catch:{ Exception -> 0x000d, all -> 0x0016 }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (event.getSource() == 8194 && SDLActivity.mSeparateMouseAndTouch) {
            ...
            switch (action) {
                ...
                case 3:
                    for (i = 0; i < pointerCount; i++) {
                        SDLActivity.onNativeTouch(touchDevId, event.getPointerId(i), 1, event.getX(i) / mWidth, event.getY(i) / mHeight, event.getPressure(i));
                    }
                    break;
                case 5:
                case 6:
